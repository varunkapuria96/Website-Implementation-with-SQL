                ...
                <div class="form-content">
                    ...
                    <?php
                        ...
                        <form class="requires-validation" action="my_queries.php" method="post">
                            ...
                            <div class="col-md-12">
                                <label for="customer_query"><b>Kindly tell us about your query.</b></label>
                                <br>
                                <?php
                                
                                //print '<p class="form-control" style="background-color: #e9edf0; margin-top:16px;" >'.$fname.'</p>';
                                print '<textarea class="form-control" type="text" name="customer_query" style="
                                margin-top: 10px;
                                background: #F8F9FA;
                            " required></textarea>';
                                
                                print '<input type="hidden" name="time_stamp" value='.gmdate('Y-m-d h:i:s \G\M\T', time()).'>';
                                print '<input type="hidden" name="time_stamp" value='.time().'>';
                                ?>
