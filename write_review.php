            ...
            <div class="form-holder">
                <div class="form-content">
                    ...
                    <?php
                        ...
                        ?>
                        <form class="requires-validation" action="orders.php" method="post">
                        <?php
                        if ($_POST['write_review']){
                        ?>
                            <div class="col-md-12">
                                <label for="customer_query"><b>Kindly write a review about <?php echo $product_name?>.</b></label>
                                <br>
                                <?php
                                print '<textarea class="form-control" type="text" name="product_review" style="
                                margin-top: 10px;
                                background: #F8F9FA;
                            " required></textarea>';
                        ...
                        <?php
                        } else if($_POST['update_review']) {
                            ?>
                            <div class="col-md-12">
                                <label for="customer_query"><b>Kindly update your review about <?php echo $product_name?>.</b></label>
                                <br>
                                <?php
                                print '<textarea class="form-control" type="text" name="updated_product_review" style="
                                margin-top: 10px;
                                background: #F8F9FA;
                            " required></textarea>';
                                print '<input type="hidden" name="product_name" value='.$product_name.'>';
                        ...
                        ?>
                            <div class="form-button mt-3">
                                ...
                                <input class="btn btn-primary" type="submit" name= "submit_review" value="Submit">
                            </div>
